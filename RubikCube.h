...
protected:
	...
	void initColor() {
		cube[0].face[0].updateColor(TypeColor::COLOR_RED);			// red
		cube[0].face[1].updateColor(TypeColor::COLOR_GREEN);		// green
		cube[0].face[2].updateColor(TypeColor::COLOR_ORANGE);		// orange

		cube[1].face[0].updateColor(TypeColor::COLOR_YELLOW);		// yellow
		cube[1].face[1].updateColor(TypeColor::COLOR_GREEN);		// green
		cube[1].face[2].updateColor(TypeColor::COLOR_ORANGE);		// orange

		cube[2].face[0].updateColor(TypeColor::COLOR_RED);			// red
		cube[2].face[1].updateColor(TypeColor::COLOR_GREEN);		// green
		cube[2].face[2].updateColor(TypeColor::COLOR_WHITE);		// white

		cube[3].face[0].updateColor(TypeColor::COLOR_YELLOW);		// yelloW
		cube[3].face[1].updateColor(TypeColor::COLOR_GREEN);		// green
		cube[3].face[2].updateColor(TypeColor::COLOR_WHITE);		// white

		cube[4].face[0].updateColor(TypeColor::COLOR_RED);			// red
		cube[4].face[1].updateColor(TypeColor::COLOR_BLUE);			// blue
		cube[4].face[2].updateColor(TypeColor::COLOR_ORANGE);		// orange	

		cube[5].face[0].updateColor(TypeColor::COLOR_YELLOW);		// yello
		cube[5].face[1].updateColor(TypeColor::COLOR_BLUE);			// blue
		cube[5].face[2].updateColor(TypeColor::COLOR_ORANGE);		// orange

		cube[6].face[0].updateColor(TypeColor::COLOR_RED);			// red
		cube[6].face[1].updateColor(TypeColor::COLOR_BLUE);			// blue
		cube[6].face[2].updateColor(TypeColor::COLOR_WHITE);		// white

		cube[7].face[0].updateColor(TypeColor::COLOR_YELLOW);		// yellow
		cube[7].face[1].updateColor(TypeColor::COLOR_BLUE);			// blue
		cube[7].face[2].updateColor(TypeColor::COLOR_WHITE);		// white
